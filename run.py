...
parser.add_option('-f', '--file', help='ISO to run (default ngos.iso)', default='cardinal.iso')
...
parser.add_option('-v', '--video', action='store_true', help='Show video (default)', default=False)
